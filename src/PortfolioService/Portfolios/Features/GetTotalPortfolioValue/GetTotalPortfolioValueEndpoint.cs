    ...
    internal static RouteHandlerBuilder MapGetTotalPortfolioValueEndpoint(this IEndpointRouteBuilder builder)
    {
        return builder.MapGet(
            ...
            .WithSummaryAndDescription(
                "Retrieve total value of a portfolio", // Updated summary
                "Gets the total value of the portfolio identified by the specified ID, in the specified currency") // Updated description
